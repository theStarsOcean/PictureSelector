...
final class CameraXModule {
    ...
    void bindToLifecycleAfterViewMeasured() {
        ...
        //mVideoCaptureConfigBuilder.setIFrameInterval(1);
//        mVideoCaptureConfigBuilder.setVideoFrameRate(getDisplaySurfaceRotation());
//        mVideoCaptureConfigBuilder.setBitRate(getDisplaySurfaceRotation());
